...
if(isset($_POST['them'])){		
	...
	if($ngaybd==''||$ngaykt==''||$maxuatxu==''||$sotienkm=='')
		{	
...
{
	$obj->insert("insert into `khuyenmaisp`(`ngaybd`,`ngaykt`,`maxuatxu`,`sotienkm`,`admin`) values ($ngaybd,$ngaykt,$maxuatxu,$sotienkm,$admin)");
