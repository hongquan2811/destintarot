...
$dansachsanphamngaytao2=$obj->select("SELECT * FROM `sanpham` ORDER BY `ngaytao` DESC LIMIT 4,4");
$dansachsanphamnvsmart=$obj->select("SELECT * FROM `sanpham` where maxuatxu='3' ORDER BY `ngaytao` LIMIT 0,4");
